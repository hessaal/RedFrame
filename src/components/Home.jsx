...
export class Home extends Component {
    ...
    render() {
        return (
            <div >
                <div className='row my-5 ml-md-5'>
                    <CSSTransition
                        timeout={1500}
                    ...
                    <div id="right_side_container" className={this.state.show ? ' FP_container_entering col-md-6 col-xs-12 ' : '  FP_container_exiting col-md-6 col-xs-12 '}>
